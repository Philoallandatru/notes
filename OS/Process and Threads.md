>   Above all of these, I think the purpose of writing this is to make you think about concepts.

##### How to run existing program?

In C, there are exec*

Rule for Unix exec* functions: 

1.  If you use "p", you find the excutable file by file name. 
2.  If you use "l", you do it by specifying the file path.
3.  If you use "e", you can pass new environment variable
4.  If you use "v", you specify parameter by using array.

What about Assembly or Java or even python?
...
Process is an excution environment.

Process encaupsulates thread«s



##### Simultaneous MultiThreading/Hyperthreading

Using Hardware technique to implement multithreading: hyper threading   

​       

x86 actually has 4 modes(instead of 2 modes. )



# Code Analysis

### Processs control: fork and signal
